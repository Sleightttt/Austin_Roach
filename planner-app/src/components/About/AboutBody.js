const AboutBody = ({ activeTheme }) => {
  ...
  return (
	...
	c1.896-1.896,2.844-3.791,2.844-5.688c0-2.844,0-9.006,0-9.006V24.882C48.444,15.719,41.018,8.292,31.854,8.292z"
          />
          <ellipse fill="#f0f3fb" cx="34.5" cy="37" rx="3.5" ry="5" />
          <ellipse fill="#f0f3fb" cx="29.959" cy="23.459" rx="2.37" ry="4.74" />
          <ellipse fill="#f0f3fb" cx="38.49" cy="23.459" rx="2.37" ry="4.74" />
        </svg>
        <svg
          className="about-icon"
          xmlns="http://www.w3.org/2000/svg"
