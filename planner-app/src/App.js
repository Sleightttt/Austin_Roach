...
function App() {
  ...
  const themeFixer2 = () => {
    ...
    return { textStyle, borderStyle, decoColor, fill };
  };

  const { textStyle, borderStyle, decoColor, fill } = themeFixer2();
